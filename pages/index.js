...
const data = {
  ...
  rows: [
    ...
    },
    {
      ...
      content: `<p>Some instructions to the wedding would be nice to put ehre</p>`,
    },
    {
      title: "Where should we stay?",
      content: `<p>As August is a peak tourist season we strongly recommend booking your accommodation ASAP. Below are some recommendations but be sure to check cancellation policies before booking just in case....</p>`,
    },
    {
    ...
    },
    {
      ...
      content: `We have made you travel all this way and we want to say thank you with a backyard celebration at our house. Food and drinks will be provided along with acoustic music and lawn games. We know that this is the only time all our loved ones will be in the same place so we want to cherish every moment we can.  `,
    },
    {
      title: "Are we allowed to ask about the 'C' word?",
      content:
        "The virus which shall not be named is almost gone but still lingering. We are hopeful that our celebration will go ahead this time around. Should anything change we will update this website and get in contact with you.",
    },
  ],
};
...
export default function Home() {
  ...
  return (
    <div className="websiteContainer">
      <HomeStyles />
      <Head>
        <title>Tom and Kate&apos;s Wedding</title>
        ...
        <div className="row">
          <div className="col-12">
            ...
            <FadeInWhenVisible delay="0.20">
              <p className="rsvpBy">
                Your reply is appreciated by Friday, July 1st
              </p>
            </FadeInWhenVisible>
            <FadeInWhenVisible delay="0.3">
              <hr className="fatHR" />
